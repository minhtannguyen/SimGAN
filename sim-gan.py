...
def refiner_network(input_image_tensor):
    ...
    def resnet_block(input_features, nb_features=64, nb_kernel_rows=3, nb_kernel_cols=3):
        ...
        """
        y = layers.Convolution2D(nb_features, nb_kernel_rows, nb_kernel_cols, border_mode='same', kernel_initializer='ones')(input_features)
        y = layers.Activation('relu')(y)
        y = layers.Convolution2D(nb_features, nb_kernel_rows, nb_kernel_cols, border_mode='same', kernel_initializer='ones')(y)

        y = layers.merge([input_features, y], mode='sum')
        return layers.Activation('relu')(y)

    # an input image of size w x h is convolved with 3 x 3 filters that output 64 feature maps
    x = layers.Convolution2D(64, 3, 3, border_mode='same', activation='relu', kernel_initializer='ones')(input_image_tensor)
    ...
    return layers.Convolution2D(img_channels, 1, 1, border_mode='same', activation='tanh', kernel_initializer='ones')(x)
